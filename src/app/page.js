...
export default function Home() {
  ...
  return (
    ...
    <div className="max-w-7xl grid grid-cols-2 gap-x-8 content-start mx-auto pt-4">
      ...
      <div className='absolute bottom-4 px-3 py-3  text-white text-xs font-medium right-4 bg-gradient-to-b from-gray-700 to-gray-900 border border-gray-900  backdrop-blur-md rounded-md'>
